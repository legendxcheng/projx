package MCW.Resource.Parser
{
	...
	*/
	public class ImgAnimParser implements IParser
	{
		...
		public function ImgAnimParser(rtype:int, rid:int, data:*)
		{
			_rtype = rtype;
			_rid = rid;
		...
		public function mergeBuf():void
		{
			...
			resMgr.plugResource(ResManager.RES_IMG_ANIM, _rid, _anim);
		}
	}
}