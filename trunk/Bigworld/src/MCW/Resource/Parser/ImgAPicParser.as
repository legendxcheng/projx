package MCW.Resource.Parser
{
	...
	/*
	class for parsing alpha pic
	one pic with alpha channel
	*/
	public class ImgAPicParser implements IParser
	{
		private var _rtype:int;
		private var _rid:int;
		private var _data:ByteArray;
		private var _pic:MSPic;
		...
		public function ImgAPicParser(rtype:int, rid:int, data:*)
		{
			_rtype = rtype;
			_rid = rid;
		...
		public function parseResource():void
		{
			...
			var tpJson:Object = JSON.parse(jsonStr);
			_rid = tpJson.rid;
		...
		public function mergeBuf():void
		{
			...
			resMgr.plugResource(ResManager.RES_IMG_APIC, _rid, _pic);
		}
	}
}